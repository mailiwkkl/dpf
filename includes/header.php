            ...
            <nav class="nav">
                <ul>
                    ...
                    <?php if ($is_logged_in): ?>
                        ...
                        <li><a href="orders.php"><i class="fas fa-receipt"></i> Facturas</a></li>
                                               <?php if ($is_admin): ?> 
                       <li><a href="admin/invoices.php"><i class="fas fa-shopping-cart"></i> Pedidos</a></li>
                         <?php endif; ?>   
                        ...
                        <?php if ($is_admin): ?>
                            <li><a href="admin/dashboard.php"><i class="fas fa-cog"></i> Administración</a></li>
                        <?php endif; ?>
